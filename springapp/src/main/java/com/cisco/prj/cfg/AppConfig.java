...
public class AppConfig {
	...
	public DriverManagerDataSource dataSource() {
		...
		ds.setUrl("jdbc:mysql://localhost:3306/CISCO_TRG_2020?createDatabaseIfNotExist=true");
		ds.setUsername("root");
	...
	public LocalContainerEntityManagerFactoryBean emf(DataSource ds) {
		...
		emf.setJpaVendorAdapter(new HibernateJpaVendorAdapter()); // hibernate as ORM
		...
		props.setProperty("hibernate.hbm2ddl.auto", "update"); // create or use existing 
